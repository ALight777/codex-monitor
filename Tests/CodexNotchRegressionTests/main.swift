...
runner.check(AppInfo.version == "0.1.16", "app info should expose version 0.1.16")
runner.check(AppInfo.displayVersion == "0.1.16", "app info should fall back to source version when bundle version is unavailable")
